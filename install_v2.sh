...
$sudo_cmd curl -o $WORKDIR/mysqlconfigurer.sh https://releem.s3.amazonaws.com/mysqlconfigurer_v2.sh  2>/dev/null
$sudo_cmd curl -o $WORKDIR/releem-agent https://releem.s3.amazonaws.com/releem-agent 2>/dev/null
