...
func (DbCollectQueriesOptimization *DbCollectQueriesOptimization) GetMetrics(metrics *models.Metrics) error {
	...
	QueriesOptimization := make(map[string][]models.MetricGroupValue)
	{
		var output []models.MetricGroupValue
