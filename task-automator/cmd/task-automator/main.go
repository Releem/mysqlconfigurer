...
import (
	...
	"task-automator/internal/config"
	"task-automator/internal/db"
	"task-automator/internal/phase1"
...
func runPhase1(conn *db.Connection, ddlStatements []string) {
...
func runPhase2(conn *db.Connection, dsn, sql string, backupMethod phase2.BackupMethod, usePTOSC bool, debug bool, cfg *config.Config) {
